...
public class Tree extends JFrame {
    ...
    Tree(String Redy_Infix_for_Draw  , String Redy_Prefix_for_Draw , String Postfix ,String Redy_Infix_for_Write  , String Redy_Prefix_for_Write,HashMap<String, String> for_Use_Unique_Charecter) {
        ...
        while (0 < prefix.length()) {
            ...
            if (infix.indexOf(root.charAt(0)) + 1 < infix.length()) {
                ...
                for (int i = infix.indexOf(root.charAt(0)) + 1; i < infix.length(); i++) {
                   ...
                   if ("(".equals(Character.toString(infix.charAt(i))) ||")".equals(Character.toString(infix.charAt(i)))){ continue;}
...
//                char someChar = prefix.charAt(0);
//                int count = 0;
//                for (int i = 0; i < prefix.length(); i++) {
//                     if (prefix.charAt(i) == someChar) {
//                    count++; }
//                    }

//                if (1<count)
//                {
//                    prefix = prefix.replaceFirst(Character.toString(prefix.charAt(0)), "");
...
//                {
        ...
        if (Stack_Root.size() == 1) {     System.out.println(" Hichi Nadaram "); }
        while (Left_or_Right.get(Whats_Component  + "_Left") == 1 || Left_or_Right.get(Whats_Component  + "_Right") == 1) {
            
            if (Left_or_Right.get(Whats_Component  + "_Left") == 0){ Create_btn(Whats_Component , Position , panel,for_Use_Unique_Charecter);}
            ...
            while (Left_or_Right.get(Whats_Component  + "_Left") == 1) {
                ...
                while (Left_or_Right.get(Whats_Component  + "_Right") == 0) {
                    ...
                    Index_of_Stack_Root -= 1;
                    System.out.println(Whats_Component);
                    System.out.println(Stack_Root);
    ...
    public void Create_btn (String character,int Position[] ,JPanel panel , HashMap<String, String> for_Use_Unique_Charecter){
                ...
                if (for_Use_Unique_Charecter.containsKey(character)){character=for_Use_Unique_Charecter.get(character);}
                btn.setText(character);
                btn.setFocusable(false);
                btn.setForeground(Color.CYAN);
                btn.setBackground(Color.CYAN);
                if (Position[2]>50){btn.setFont(new Font("homa ", Font.BOLD, 25));}
                else{btn.setFont(new Font("homa ", Font.BOLD, 15));}
